...
// Keep user's structure: base may already include '/api'
...
export async function GET(req: NextRequest) {
  ...
  const meResp = await fetch(`${API_URL}/Auth/me`, {
    ...
    const url = stationID
      ? `${API_URL}/Booking/GetAllBookingOfStation?stationID=${encodeURIComponent(stationID)}`
      : `${API_URL}/Booking/GetAllBooking`;
